...
const HeaderSection = () => (
  <div className="text-center">
    <p className='text-[#04211e] text-[0.9rem] md:text-[1rem] tracking-wider uppercase'>
      OUR SERVICES
    </p>
    <h1 className='md:text-[2.5rem] text-[1.5rem] font-extrabold text-[#04211e] leading-tight'>
    ...
    {Data.map((item, index) => (
      <div key={index} className='px-4 h-auto'>
        <div className='bg-white shadow-inner rounded-2xl border border-[#61dbd1]/40 h-[300px] w-[200px] mx-auto text-[#04211e] flex flex-col justify-center items-center gap-2 p-2 transform transition duration-300 hover:-translate-y-3 hover:scale-90'>
          ...
          {/* Icon Box */}
          <div className='w-[100px] h-[100px] flex justify-center items-center text-white bg-[#40408d] rounded-2xl shadow-sm'>
